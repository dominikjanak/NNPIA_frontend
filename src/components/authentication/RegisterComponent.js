          ...
          <div className="col-12">
            <form className="register bg-gray-2 py-5 px-4" onSubmit={(e) => this.handleSubmit(e)}>
              ...
              <div className="form-group mt-3">
                ...
                <input type="text" className="form-control" name="firstname" required placeholder="Zadejte jméno"  value={this.state.firstname} onChange={this.onChange} />
              </div>

              <div className="form-group mt-3">
                <label htmlFor="surname">Příjmení:</label>
                <input type="text" className="form-control" name="surname" required placeholder="Zadejte příjmení"  value={this.state.surname} onChange={this.onChange} />
              </div>

              <div className="form-group mt-3">
                <label htmlFor="email">Email:</label>
                <input type="email" className="form-control" name="email" required placeholder="Zadejte email"  value={this.state.email} onChange={this.onChange} />
              </div>
